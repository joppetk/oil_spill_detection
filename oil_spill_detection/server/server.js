...
const OPS = {
  ...
  CKPT_UNET_DENSE: process.env.CKPT_UNET || path.resolve(__dirname, '..', 'python-poller', 'weights', 'unet_densenet201_oil_fold5_ft_best.pt'),
  ...
  CFG_DLV3:  process.env.CFG_DLV3  || path.resolve(__dirname, '..', 'python-poller', 'weights', 'infer_config_deeplab.json'),
...
app.post('/admin/infer', async (req, res) => {
  try {
    ...
    const MODEL_MAP = {
      ...
      unet_densenet: {
        ckpt: OPS.CKPT_UNET_DENSE,       // e.g. "C:/.../unet_b48_best.pth"
        cfg:  OPS.CFG_UNET,        // e.g. "C:/.../unet_cfg.json"
        name: 'unet_densenet',          // value for --model
      },
      deeplabv3_v1: {
