...
\restrict ZagzyvDhcxcjtpYBlnt4bGlyofR4rjuXMiSdEdTRnmVldQVevSfeBsstBXtgMLb
...
--
-- Name: response_actions response_actions_tier_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: oil
--

ALTER TABLE ONLY public.response_actions
    ADD CONSTRAINT response_actions_tier_id_fkey FOREIGN KEY (tier_id) REFERENCES public.response_tiers(id) ON DELETE CASCADE;
...
--
-- Name: response_plans response_plans_tier_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: oil
--

ALTER TABLE ONLY public.response_plans
    ADD CONSTRAINT response_plans_tier_id_fkey FOREIGN KEY (tier_id) REFERENCES public.response_tiers(id);
...
\unrestrict ZagzyvDhcxcjtpYBlnt4bGlyofR4rjuXMiSdEdTRnmVldQVevSfeBsstBXtgMLb
